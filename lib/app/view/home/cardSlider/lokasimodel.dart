...
class Lokasi {
  ...
  Lokasi({required this.nama, required this.latitude, required this.longitude});
}
...
final List<Coffee> coffeeShops = [
  Coffee(
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipOP3A_aa72sd5Idu57fOskuTDfXAJZgO8QTpDiX=w408-h272-k-no'),
  Coffee(
      id: "vcxvxvde2",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipPHJ8OS3NanBuvxNA46guMERW5KGkhm9mySfsN6=w408-h272-k-no'),
  Coffee(
      id: "cxvxfe2",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipMouWpZt9ph49uKhIZrn7wfSIS68BU8JDZtoEFk=w408-h306-k-no'),
  Coffee(
      id: "dsakdfs24",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipOcYz0IvXy3iKeiyoTqVYL6doj3xPj8OsN9IoWS=w427-h240-k-no'),
  Coffee(
      id: "vcxe24",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipPIDMNHBYYtQ7aYVB7-kFVvTKbbUHC4dsFpth2U=w408-h612-k-no'),
  Coffee(
      id: "vdsg42a",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipORpCE38GEBjvmFeP2fO3yrHfKLjVb_wswX-Y_N=w408-h271-k-no'),
  Coffee(
      id: "dsgsd42z",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipM6YJb5R5BUEvT-Om_sxDo-bKILLJeW6hz9gHlp=w408-h306-k-no'),
  Coffee(
      id: "vcxqrw1",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipO_JQlaiJSBBLJclOtZ1NiE0LWb7PoSq7sXp23w=w408-h272-k-no'),
  Coffee(
      id: "bfdgds3",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipOYWl5LbWtWkTIyYu5J28gW8zkrDKbh-Gi-0vbd=w408-h325-k-no'),
  Coffee(
      id: "gdsknk24",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipNiMORD6qn0SxerZbLhWD7uMuHkAhZIxcMVYbXl=w426-h240-k-no'),
  Coffee(
      id: "vsdgfea1",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipNGnlu1u_-DJY2JIhZMeWxEkkXO08Pull4-BMx3=w408-h271-k-no'),
  Coffee(
      id: "vdsvdsg24",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipPTZe5UwMTffez0otVtnSJfWW0kKA3Up4pG242s=w408-h306-k-no'),
  Coffee(
      id: "vcxsqr32",
      ...
      thumbNail:
          'https://lh5.googleusercontent.com/p/AF1QipMXTgJv8vGWJqjUHrCwGCJOorbg8HTfFboIn7hA=w408-h271-k-no'),
];
