            ...
            if (sb.hasError == false) {
              ...
              if (!await sb.isUserVerified()) {
                ...
                sb
                    ...
                    .then((value) {
                  sb.role == "admin_specific" ?
                  Navigator.popAndPushNamed(context, Routes.adminHomeScreenRoute) : Navigator.popAndPushNamed(context, Routes.homeScreenRoute);
                });
              }
            } else {
              _btnController.reset();
