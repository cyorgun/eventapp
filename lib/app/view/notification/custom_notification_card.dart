            ...
            children: [
              Container(
                ...
                child: Padding(
                  ...
                  child: getCustomFont(date.toString(), 18.sp, Colors.black, 1,
                      fontWeight: FontWeight.w700, txtHeight: 1.5.h),
                ),
              ),
              Padding(
                padding:
                    const EdgeInsets.only(top: 23.0, bottom: 10.0, left: 15.0),
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      child: getSvgImage("notification-image.svg",
                          color: Colors.white, width: 24.h, height: 24.h),
                    ),
                      ...
                      child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: getCustomFont(notificationModel.title!,
                                  19.sp, Colors.black, 1,
