...
class _TangsakpalsState extends State<Tangsakpals> {
  ...
  Future<void> _captureAndShareImage() async {
    try {
      ...
      final String? imagePath = await widget.screenshotController?.captureAndSave(
        directory,
      ...
      if (imagePath != null) {
        ...
        await Share.shareXFiles([XFile('${imagePath}')], text: 'Check out this event ticket!');
      } else {
                    ...
                    child: Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Image.network("https://cdn-icons-png.freepik.com/256/3983/3983877.png?semt=ais_hybrid",
                          height: 40.0,
                          width: 40.0,
                          ),
                        ),
                        SizedBox(width: 10.0,),
                        Text("Share on WhatsApp",style: TextStyle(color: Colors.white),)
                      ],
                    ),
                  ),
                ),
